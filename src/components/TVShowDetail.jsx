         ...
         {credits?.cast && credits.cast.length > 0 && (
           <div>
             ...
             <div style={{
               ...
               <button 
                 onClick={() => {
                   const container = document.getElementById('tv-cast-slider');
                   if (container) {
              ...
              <style>
                {`
                  #tv-cast-slider::-webkit-scrollbar {
                    height: 6px;
                  }
                  #tv-cast-slider::-webkit-scrollbar-track {
                    background: #f1f1f1;
                    border-radius: 3px;
                  }
                  #tv-cast-slider::-webkit-scrollbar-thumb {
                    background: #c1c1c1;
                    border-radius: 3px;
                  }
                  #tv-cast-slider::-webkit-scrollbar-thumb:hover {
                    background: #a8a8a8;
                  }
                `}
              </style>

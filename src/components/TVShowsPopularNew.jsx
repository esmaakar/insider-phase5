...
const TVShowsPopularNew = () => {
  ...
  const platforms = {
    ...
    'disney': { name: 'Disney+', icon: '🎭', id: 337 } // Disney+ provider_id for TV
  };
    ...
    const initializeData = async () => {
      ...
      try {
        const [genresResponse, showsResponse] = await Promise.all([
          ...
          fetch(`${BASE_URL}/discover/tv?api_key=${API_KEY}&language=en-US&sort_by=${sortBy}&page=${page}`)
        ]);
    ...
    return (
      <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
        <div style={{ width: '300px', backgroundColor: '#f8f9fa', padding: '2rem', position: 'fixed', height: '100vh', overflowY: 'auto' }}>
          ...
          {/* Where To Watch Section (card-like, separate) */}
          <div style={{
            marginBottom: '1.5rem',
            backgroundColor: '#fff',
            borderRadius: '8px',
...
export default TVShowsPopularNew;